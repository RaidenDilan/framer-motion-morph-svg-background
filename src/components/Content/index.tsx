...
const Content = () => {
  return (
    <div className="content content--fixed" data-testid="Content">
      <header className="codrops-header">
        ...
        <h1
          ...
          data-testid="codrops-header__title"
        >
          Morphing Background Shapes
        </h1>
      </header>
      <nav className="demos">
        <a className="demo" href="index.html" data-testid="demo-1">
        ...
        <a className="demo" href="index3.html" data-testid="demo-3">
          <svg className="decoshape">
            <use xlinkHref="#shape-demo"></use>
          </svg>
          Demo 3
      ...
      <a className="pater" href="http://synd.co/2pHxJny">
        ...
        <img
          ...
          src={helloSignAPI}
          alt="HelloSign API"
          data-testid="pater__img"
        />
        <h4 className="pater__title" data-testid="pater__title">
          2x Faster Integration Time
        </h4>
        <p className="pater__desc" data-testid="pater__desc">
          Embed contracts and agreements into your site or app with a few lines
          of code.
        </p>
      </a>
      <div className="deco deco--title" data-testid="deco__title">
        2017 Westland Exhibition Center
      </div>
    </div>
  );
};
